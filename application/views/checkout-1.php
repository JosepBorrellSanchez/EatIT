        ...
        <div class="col-md-7 col-xs-12">
					...
					<form action="#">
						  <div class="row">
							  <div class="col-sm-6 col-xs-12">
								<div class="input-field-wrap">  
								  <input type="text" class="input-field color-2" placeholder="Nom *" required>
								  <div class="focus"></div>
								</div>  
							  ...
							  <div class="col-sm-6 col-xs-12">
								<div class="input-field-wrap"> 
								  <input type="text" class="input-field color-2" placeholder="Cognom">
								  <div class="focus"></div>
								</div>    
								<div class="empty-sm-20 empty-xs-20"></div>    
							  </div>
						  ...
						  <div class="row">
							  ...
							  <div class="col-sm-6 col-xs-12">
								<div class="input-field-wrap">
								  <input type="email" class="input-field color-2" placeholder="Telèfon *" required> 
								  <div class="focus"></div>
								</div> 
								 <div class="empty-sm-20 empty-xs-20"></div>      
							  </div>
						...
						<div class="row">
						  <div class="col-sm-6 col-xs-12">
							<div class="input-field-wrap">
							  <input type="email" class="input-field color-2" placeholder="Pais *" required> 
							  <div class="focus"></div>
							</div> 
							<div class="empty-sm-20 empty-xs-20"></div>   
						  </div>
						  <div class="col-sm-6 col-xs-12">
							<div class="input-field-wrap">
							  <input type="email" class="input-field color-2" placeholder="Codi postal *" required> 
							  <div class="focus"></div>
							</div> 
							 <div class="empty-sm-20 empty-xs-20"></div>      
						  </div>
            ...
            <div class="input-field-wrap">  
                <textarea placeholder="Direcció d'enviament *" class="input-field color-2" required></textarea>
                <div class="focus"></div> 
						</div>
            <br>
						<div class="input-field-wrap">  
               ...
               <div class="col-md-4 col-sm-4 col-xs-12">
                   <div class="footer-item">
                       ...
                       <ul class="list-style-2 ul-list">
                           ...
                           <li><span>Telèfon: </span><a href="tel:" class="link-hover">+38 056 23 15 7851</a></li>
