<header class="header header-style-5 type-2 card-include">
      <div class="navigation flex-align">   
         <a href=<?php echo site_url('Botiga')?> class="logo"><img src="<?=base_url();?>assets/img/logo.png" alt="delice"><img src="<?=base_url();?>assets/img/logo2.png" alt="delice" class="logo-type-2"></a>
