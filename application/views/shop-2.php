...
<body class="page-color-style-6 page-style-6">
    ...
    <header class="header header-style-5 type-2 card-include">
      <div class="navigation flex-align">   
         <a href="home_1.html" class="logo"><img src="<?=base_url();?>assets/img/logo.png" alt="delice"><img src="<?=base_url();?>assets/img/logo2.png" alt="delice" class="logo-type-2"></a>
           ...
           <div class="nav">
                  ...
                  <div class="search-popup">
                      ...
                      <div class="search-form-wrap"> 
                       <form action="#" class="search-form">
                           <input type="text" placeholder="Coming soon..." class="input-search" required="">
                       ...
                       <?php foreach($this->cart->contents() as $items){ ?>
                           <li class="flex-align">
                               <div class="img hover-zoom">
                                  <a href="#"><img src="<?=base_url();?>assets/img/shop_list_img_1.png" alt=""></a>
                               </div>
            ...
            <nav>
              <ul class="header-menu">
                <li><a href="home_1.html">Home<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
                    ...
                    <li class="active"><a href="shop-1.html">Shop<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
                            <li><a href="shop-1.html">Shop 1</a></li>
                            <li><a href="shop-2.html">Shop 2</a></li>
                            <li><a href="shop-3.html">Shop 3</a></li>
                            <li><a href="shop-detail-1.html">Shop Detail<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                                <ul>
                                    <li><a href="shop-detail-1.html">Shop Detail 1</a></li>
                                    <li><a href="shop-detail-2.html">Shop Detail 2</a></li>
                                </ul>
                            </li>
                            <li><a href="checkout-1.html">Order<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                                <ul>
                    ...
                    <li><a href="reservation.html">Page<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
                            <li><a href="reservation.html">Reservation</a></li>
                            <li><a href="services.html">Services</a></li>
                            <li><a href="team.html">Chefs</a></li>
                            <li><a href="menu-1.html">Menu<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                                <ul>
                            ...
                            <li><a href="gallery-1.html">Gallery<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                                <ul>
                    ...
                    <li><a href="blog-1.html">Blog<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
                            <li><a href="blog-1.html">Blog 1</a></li>
                            <li><a href="blog-2.html">Blog 2</a></li>
                            <li><a href="blog-detail-1.html">Blog Detail<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                                <ul>
                     ...
                     <li><a href="contact-1.html">Contact<img src="<?=base_url();?>assets/img/down-arrow.png" alt="" class="menu-arr"></a>
                        <ul>
  ...
  <div class="main-content">
    ...
    <section class="full-height-slider type-1">
       <div class="bg ready data-jarallax" data-jarallax="5" style="background-image: url(<?=base_url();?>assets/img/shop/main-naner-bg-2.jpg)" data-swiper-parallax="50%"></div>
          ...
          <div class="col-lg-2 col-md-3 col-xs-12">
            ...
            <div class="filter-open">
              <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 54 54" style="enable-background:new 0 0 54 54;" xml:space="preserve">
                <g><path d="M1,9h3v4c0,0.553,0.447,1,1,1h12c0.553,0,1-0.447,1-1V9h35c0.553,0,1-0.447,1-1s-0.447-1-1-1H18V3c0-0.553-0.447-1-1-1H5
            ...
            <div class="menu-filter">
              ...
              <aside>
                ...
                <ul class="list-style-4 type-2 ul-list">
                  ...
                  <li><a href="#" class="link-hover"><?php echo $categoria->nom; ?></a></li>
                  <?php }?>
                </ul>
              </aside>
                ...
                <div class="shop-filter">
                  <div class="found-items">
                    <div class="simple-text">
                        <p>Found <span class="main-col"><b><?php echo count($productes)?></b></span> items</p>
                    </div>
                  </div>
                  <div class="shop-select">
                    ...
                    <div class="sort-by">
                      ...
                      <select class="input-field type-2 main-col">
                        <option value="val1">Coming soon</option>
                      </select> 
                    </div>
                      ...
                      <div class="menu-item menu-item-2 type-3">
                          <div class="image hover-zoom">
                            <a href="#" class="like-product main-fill-col">
                              ...
                              <img src=<?php echo $producte->miniatura; ?> alt="">
                          ...
                          <div class="text">
                              ...
                              <h5 class="h5 caption"><a href="#" class="link-hover-line"><?php echo $producte->nom; ?></a></h5>
                              <div class="empty-sm-5 empty-xs-5"></div>
                              <div class="simple-text">
                                  <p><?php echo $producte->descripcio; ?></p>
                              </div>
                              <div class="empty-sm-10 empty-xs-10"></div>
                              <div class="menu-price style-2 title main-col"><?php echo $producte->preu; ?> €</div>
                          </div>
                      </div>
                  </div>
                  <?php } ?>
               ...
               <div class="col-md-4 col-sm-4 col-xs-12">
                 <div class="footer-item">  
                   ...
                   <div class="f-instagram">
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_1.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_2.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_3.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_4.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_5.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_6.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_7.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_8.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_9.jpg" alt=""></a>
                       <a href="#"><img src="<?=base_url();?>assets/img/inst_10.jpg" alt=""></a>
                   </div>
                   <div class="empty-sm-20 empty-xs-20"></div> 
                   <div class="follow follow-style-2 sm">
                       <a href="#">
          ...
          <div class="close-popup type-2">
            ...
            <div class="row left-right-item">
              <div class="col-md-6 col-xs-12">
                <img src="<?=base_url();?>assets/img/shop/pop-up.png" alt="" class="full-img">
              </div>
              <div class="col-md-6 col-xs-12">
