           ...
           <div class="row vertical-wrap">
             <div class="col-lg-6 col-lg-offset-3 col-sm-12 col-sm-offset-0">
                  ...
                  <div class="main-title">
                   <h1 class="h1 caption">Eat IT!</h1>
                   <div class="empty-sm-30"></div>
                   <div class="col-md-10 col-md-offset-1">
                     <div class="simple-text md">
                         <p>Es tracta de pagar i menjar, així de senzill.</p>
                     </div>
                   </div>
                  </div>   
                    </div>
                ...
                <div class="shop-filter">
                  <div class="found-items">
                    <div class="simple-text">
                        <p>Total <span class="main-col"><b><?php echo count($productes)?></b></span> productes</p>
                    </div>
                  </div>
                      ...
                      <div class="menu-item menu-item-2 type-3">
                          <div class="image hover-zoom">
                            <a href="#" class="like-product main-fill-col">
                              ...
                              <img src=<?php echo $producte->miniatura; ?> alt="" width="100" height="100">
                              <div class="vertical-align full menu-button">
                                  <a href=<?php echo site_url('/botiga/add/'.$producte->id)?> class="page-button button-style-1 type-4"><span class="txt">Afegir </span></a>
